...
Assert-True ($patcher.Contains('Copy-Item -LiteralPath $Script:BackupPath -Destination $official.Asar -Force')) "Failed installs do not restore the managed backup"
